...
export type { BindingBuilder, BindingShape, BindingValue, BuildContext, Component, DependencyResolver, Env, EnvId, ImageRef, PostgresRecord, ResourceRecord, Resolved, ServiceRecord, TokenResolver, } from "./types.js";
export declare function defineComponent<B extends BindingShape>(name: string, spec: ComponentSpec<B>): Component<B>;
