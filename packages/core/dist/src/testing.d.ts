import { type ComponentModule, type EvaluationResult, type InputDeclarations, type JsonValue, type OutputDeclarations } from "./sdk.js";
...
export declare class FakeHost<Inputs extends InputDeclarations, Outputs extends OutputDeclarations> {
    ...
    constructor(component: ComponentModule<Inputs, Outputs>);
