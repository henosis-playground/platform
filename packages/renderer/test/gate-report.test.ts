...
describe("parseCompileFailures", () => {
  it("names the consumer, producer, and missing binding field", () => {
    const output = [
      "../../node_modules/@henosis/service-b/src/index.ts(10,33): error TS2339: Property 'api' does not exist on type '{ newApiName: BindingValue; }'.",
      "",
    ].join("\n");
